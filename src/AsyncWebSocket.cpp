...
*/
const char * AWSC_PING_PAYLOAD = "AsyncWebServer_ESP32_ENC-PING";
//const size_t AWSC_PING_PAYLOAD_LEN = 29;
const size_t AWSC_PING_PAYLOAD_LEN = String(AWSC_PING_PAYLOAD).length();
