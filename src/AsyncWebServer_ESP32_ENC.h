/****************************************************************************************************************************
  AsyncWebServer_ESP32_ENC.h - Dead simple Ethernet AsyncWebServer.
...
#define _AsyncWebServer_ESP32_ENC_H_
...
#else
  #error This code is designed for ESP32_ENC to run on ESP32 platform! Please check your Tools->Board setting.
#endif
...
#ifndef ESP32_ENC_AWS_UNUSED
  #define ESP32_ENC_AWS_UNUSED(x)       (void)(x)
#endif
...
#endif /* _AsyncWebServer_ESP32_ENC_H_ */
