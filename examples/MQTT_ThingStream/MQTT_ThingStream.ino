...
/*
  ...
  - publishes {Hello from MQTTClient_SSL on RP2040W} to the topic [ESP32_ENCPub]
  - subscribes to the topic [ESP32_ENCSub], printing out any messages
...
#define USING_THINGSTREAM_IO      false   //true
	...
	String      topic       = "ESP32_ENC_Pub";            // Topic to publish
	String      subTopic    = "ESP32_ENC_Sub";            // Topic to subcribe to
